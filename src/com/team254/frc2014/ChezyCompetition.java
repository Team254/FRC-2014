...
public class ChezyCompetition extends ChezyIterativeRobot {
  ...
  public void printJoystickValues() {
    ...
    lcd.println(DriverStationLCD.Line.kUser4, 1, "l: " + Math.floor(ChezyRobot.drivebase.getLeftEncoderDistanceInMeters() * 10) / 10 + " r: " + Math.floor(ChezyRobot.drivebase.getRightEncoderDistanceInMeters() * 10) / 10 + " g: " + Math.floor(ChezyRobot.drivebase.getGyroAngleInRadians() * 10) / 10);
    lcd.updateLCD();
  }
}